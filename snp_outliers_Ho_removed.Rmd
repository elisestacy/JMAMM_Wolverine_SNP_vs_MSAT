...
vcf <- read.vcfR("SNPs/data/AK_YK/051923_iterative_filtering/gulo_snp_all_thinned.vcf")
snp_IDs <- extract.gt(vcf) %>% as.data.frame() %>% colnames() %>% as.data.frame()

lfmm <- vcf2lfmm("SNPs/data/AK_YK/051923_iterative_filtering/gulo_snp_all_thinned.vcf")
